...
$route['categories_html/(:any)'] = 'welcome/categories_html/$1';
$route['categories_html/(:any)'] = 'categories_html/$1';
$route['products_to_category/(:any)'] = 'welcome/products_to_category/$1';
